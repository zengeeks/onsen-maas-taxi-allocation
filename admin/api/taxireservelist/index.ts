...
const taxireservelist: AzureFunction = async function (
  context: Context,
  req: HttpRequest,
): Promise<void> {
  try {
...
export default taxireservelist
